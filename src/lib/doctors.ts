...
export const doctorsData: Doctor[] = [
  {
    ...
    specialtyTr: "Göğüs Cerrahisi & Başhekim",
    specialtyEn: "Thoracic Surgery & Chief Physician",
    specialtyAr: "جراحة الصدر ورئيس الأطباء",
    specialtyRu: "Торакальная хирургия и главный врач",
    specialtyKa: "თორაკალური ქირურგია და მთავარი ექიმი",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Çocuk Sağlığı ve Hastalıkları",
    specialtyEn: "Pediatric Health & Diseases",
    specialtyAr: "صحة الأطفال وأمراضهم",
    specialtyRu: "Детское здоровье и болезни",
    specialtyKa: "ბავშვთა ჯანმრთელობა და დაავადებები",
    category: "internal",
  ...
  },
  {
    ...
    specialtyTr: "Çocuk Onkolojisi & Hematolojisi",
    specialtyEn: "Pediatric Oncology & Hematology",
    specialtyRu: "Детская онкология и гематология",
    specialtyKa: "ბავშვთა ონკოლოგია და ჰემატოლოგია",
    category: "internal",
  ...
  },
  {
    ...
    specialtyTr: "Dermatoloji (Deri ve Zührevi)",
  ...
  },
  {
    ...
    specialtyTr: "Kulak Burun Boğaz (KBB)",
    specialtyEn: "Otorhinolaryngology (ENT)",
    specialtyRu: "Оториноларингология (ЛОР)",
    specialtyKa: "ოტორინოლარინგოლოგია (ყელ-ყურ-ცხვირი)",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Üroloji (Onkolojik)",
    specialtyEn: "Urology (Oncological)",
    specialtyRu: "Урология (Онкологическая)",
    specialtyKa: "უროლოგია (ონკოლოგიური)",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Göğüs Hastalıkları",
    specialtyEn: "Pulmonary Diseases",
  ...
  },
  {
    ...
    specialtyTr: "İç Hastalıkları (Gastroenteroloji)",
    specialtyEn: "Internal Medicine (Gastroenterology)",
    specialtyRu: "Внутренние болезни (Гастроэнтерология)",
    specialtyKa: "შინაგანი მედიცინა (გასტროენტეროლოგია)",
    category: "internal",
  ...
  },
  {
    ...
    specialtyTr: "Genel Cerrahi (Gastrointestinal)",
    specialtyEn: "General Surgery (Gastrointestinal)",
    specialtyRu: "Общая хирургия (Гастроинтестинальная)",
    specialtyKa: "ზოგადი ქირურგია (გასტროინტესტინალური)",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "İç Hastalıkları (Dahiliye)",
    specialtyEn: "Internal Medicine (General)",
    specialtyRu: "Внутренние болезни (Общие)",
    specialtyKa: "შინაგანი მედიცინა (ზოგადი)",
    category: "internal",
  ...
  },
  {
    ...
    specialtyTr: "Göğüs Cerrahisi & Akciğer Nakli",
    specialtyEn: "Thoracic Surgery & Lung Transplant",
    specialtyRu: "Торакальная хирургия и трансплантация легких",
    specialtyKa: "თორაკალური ქირურგია და ფილტვის ტრანსპლანტაცია",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Beyin ve Sinir Cerrahisi (Nöroşirürji)",
    specialtyEn: "Neurosurgery & Spine Surgery",
    specialtyRu: "Нейрохирургия и хирургия позвоночника",
    specialtyKa: "ნეიროქირურგია და ხერხემლის ქირურგია",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Çocuk Hematolojisi",
    specialtyEn: "Pediatric Hematology",
    specialtyRu: "Детская гематология",
    specialtyKa: "ბავშვთა ჰემატოლოგია",
    category: "internal",
  ...
  },
  {
    ...
    specialtyTr: "Beyin ve Sinir Cerrahisi",
  ...
  },
  {
    ...
    specialtyTr: "Çocuk Alerjisi ve İmmünolojisi",
    specialtyEn: "Pediatric Allergy & Immunology",
    specialtyRu: "Детская аллергология и иммунология",
    specialtyKa: "ბავშვთა ალერგოლოგია და იმუნოლოგია",
    category: "internal",
  ...
  },
  {
    ...
    specialtyTr: "Göz Hastalıkları (Retina & Şaşılık)",
    specialtyEn: "Ophthalmology (Retina & Strabismus)",
    specialtyRu: "Офтальмология (Сетчатка и косоглазие)",
    specialtyKa: "ოფთალმოლოგია (ბადურა და სიელმე)",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Erişkin Hematoloji (Kan Hastalıkları)",
    specialtyEn: "Adult Hematology (Blood Disorders)",
    specialtyRu: "Гематология взрослых (Заболевания крови)",
    specialtyKa: "მოზრდილთა ჰემატოლოგია (სისხლის დაავადებები)",
    category: "internal",
  ...
  },
  {
    ...
    specialtyTr: "Kardiyoloji & Girişimsel Anjiyo",
    specialtyEn: "Cardiology & Interventional Angio",
    specialtyRu: "Кардиология и интервенционная ангиопластика",
    specialtyKa: "კარდიოლოგია და ინტერვენციული ანგიოპლასტიკა",
    category: "internal",
  ...
  },
  {
    ...
    specialtyTr: "Plastik, Rekonstrüktif ve Estetik Cerrahi",
    specialtyEn: "Plastic & Reconstructive Surgery",
    specialtyRu: "Пластическая и реконструктивная хирургия",
    specialtyKa: "პლასტიკური და რეკონსტრუქციული ქირურგია",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Çocuk Gastroenterolojisi",
  ...
  },
  {
    ...
    specialtyTr: "Enfeksiyon Hastalıkları",
  ...
  },
  {
    ...
    specialtyTr: "Genel Cerrahi (Meme & Endokrin)",
    specialtyEn: "General Surgery (Breast & Endocrine)",
    specialtyRu: "Общая хирургия (Маммология и эндокринология)",
    specialtyKa: "ზოგადი ქირურგია (სარძევე ჯირკვალი და ენდოკრინული)",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Beyin ve Sinir Cerrahisi",
    specialtyEn: "Neurosurgery & Skull Base",
    specialtyRu: "Нейрохирургия и основание черепа",
    specialtyKa: "ნეიროქირურგია და თავის ქალას ფუძე",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Kadın Hastalıkları ve Doğum & IVF",
    specialtyEn: "Obstetrics & Gynecology & IVF",
    specialtyRu: "Акушерство, гинекология и ЭКО",
    specialtyKa: "მეანობა, გინეკოლოგია და IVF (ინ ვიტრო)",
    category: "surgical",
  ...
  },
  {
    ...
    specialtyTr: "Göğüs Hastalıkları",
    specialtyEn: "Pulmonary & Sleep Medicine",
    specialtyRu: "Пульмонология и сомнология",
    specialtyKa: "პულმონოლოგია და სომნოლოგია",
    category: "internal",
